...
import { callTool, getToolDefinitions, toOpenAIFormat } from '/workspace/agent/vm-tools/index.mjs'
...
async function main() {
	try {
		...
		const toolDefinitions = getToolDefinitions(agentConfig.mcp_tools)
		const tools = toOpenAIFormat(toolDefinitions)
