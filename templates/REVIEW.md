...
- Example: `./project/calculator.js:15` - Division by zero is not handled
...
## What is Wrong
- `./project/calculator.js:15-20` - Division function has no zero check
- `./project/calculator.js:5-10` - Add function doesn't validate numeric inputs
